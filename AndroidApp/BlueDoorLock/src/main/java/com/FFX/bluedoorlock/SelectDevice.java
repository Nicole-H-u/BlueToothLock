...
public class SelectDevice extends Activity implements OnItemClickListener {
    ...
    private final ArrayList<String> mArrayAdapter = new ArrayList<>();
    ...
    private void init() {
        //初始化控件
        Button btn_scan = (Button) findViewById(R.id.imageButton_scan);
        ...
        ListView list_dev = (ListView) findViewById(R.id.listView_dev);
